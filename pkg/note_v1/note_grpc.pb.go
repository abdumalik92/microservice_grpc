...
func (c *noteV1Client) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateRequest, error) {
...
func (UnimplementedNoteV1Server) Create(context.Context, *CreateRequest) (*CreateRequest, error) {
